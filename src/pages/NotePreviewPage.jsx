    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <nav className="mb-8 flex text-sm text-gray-500 font-medium">
          <a href="/notes" className="hover:text-blue-600 transition-colors">Marketplace</a>
          <span className="mx-2 text-gray-400">/</span>
          <a href={`/notes?course=${encodeURIComponent(note.course)}`} className="hover:text-blue-600 transition-colors">{note.course}</a>
          <span className="mx-2 text-gray-400">/</span>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-8">
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-xl font-bold text-yellow-700">Document Preview</h2>
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-3">
              <div className="rounded-xl bg-white p-5 text-center shadow-sm border border-gray-100">
                <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-yellow-50 text-yellow-600 mb-4">
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h4 className="font-semibold text-gray-900">Verified Quality</h4>
                <p className="mt-2 text-xs text-gray-500">Notes are reviewed by community members.</p>
              </div>
              <div className="rounded-xl bg-white p-5 text-center shadow-sm border border-gray-100">
                ...
                <p className="mt-2 text-xs text-gray-500">Ask the AI questions strictly grounded in this note.</p>
              </div>
              <div className="rounded-xl bg-white p-5 text-center shadow-sm border border-gray-100">
                ...
                <p className="mt-2 text-xs text-gray-500">Download and access the full PDF immediately.</p>
              </div>
            </div>
          </div>
