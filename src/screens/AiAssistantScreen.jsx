  ...
  return (
    <div className="mesh-bg flex h-dvh flex-col overflow-hidden bg-surface font-body text-on-surface">
      ...
      <main className="mx-auto flex min-h-0 w-full max-w-4xl flex-1 flex-col px-4 py-6 sm:px-6">
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-2xl border border-surface-variant bg-surface-container-lowest/70 shadow-level-2">
          ...
          <form onSubmit={handleSubmit} className="shrink-0 border-t border-surface-variant bg-surface-container-lowest p-3">
            <div className="flex items-end gap-2 rounded-2xl border border-surface-variant bg-surface-container-low p-2 transition-all focus-within:border-primary focus-within:ring-1 focus-within:ring-primary">
              <button
                type="button"
