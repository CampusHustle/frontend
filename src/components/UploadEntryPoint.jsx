  ...
  return (
    <div className="w-full cursor-pointer rounded-xl border-2 border-dashed border-outline-variant p-10 text-center transition-colors duration-200 hover:border-primary hover:bg-surface-variant/30">
      ...
      <div className="flex flex-col gap-4 sm:flex-row justify-center">
        {/* PDF Upload Port */}
        <label
          className={`flex cursor-pointer items-center justify-center gap-2 rounded-lg bg-amber-500 px-5 py-3 text-sm font-semibold text-gray-900 transition-colors hover:bg-amber-600 shadow-sm ${isLoading ? 'opacity-50 cursor-not-allowed pointer-events-none' : ''
            }`}
        >
          {isLoading ? (
        ...
        {/* Camera Capture Port */}
        <label
          className={`flex cursor-pointer items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-5 py-3 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-50 shadow-sm ${isLoading ? 'opacity-50 cursor-not-allowed pointer-events-none' : ''
            }`}
        >
