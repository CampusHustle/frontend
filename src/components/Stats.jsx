...
export default function Stats() {
  return (
    <section className="border-y border-surface-variant bg-surface-lowest/50">
      <div className="mx-auto grid max-w-6xl grid-cols-1 divide-y divide-surface-variant px-4 sm:grid-cols-3 sm:divide-x sm:divide-y-0 sm:px-6 lg:px-8">
        {stats.map((stat, i) => (
          <Reveal key={stat.label} delay={i * 0.08}>
            <div className="flex flex-col items-start gap-2 py-10 pr-8 sm:py-14">
              <span className="font-display text-4xl font-semibold tracking-tight text-hustle-600 lg:text-5xl">
                {stat.value}
              </span>
